<template>
  ...
  >
    <defs>
      <linearGradient
        id="ac3cc305-f6db-42f4-bbbd-32121ee27a74-563"
        x1="403.57"
        y1="833.5"
        x2="403.57"
        y2="218.16"
      ...
      <linearGradient
        id="ad14f186-b27f-416c-b629-0bafa2f1236e-564"
        x1="940.67"
        y1="825.72"
        x2="940.67"
        y2="263.72"
        xlink:href="#ac3cc305-f6db-42f4-bbbd-32121ee27a74-563"
      />
    </defs>
    <title>medicine</title>
    <ellipse cx="367.38" cy="766.65" rx="97.44" ry="15.65" fill="#2dea75" opacity="0.1" />
    <ellipse
      cx="897.05"
      cy="767.09"
      rx="121.59"
    ...
    <rect
      ...
      opacity="0.1"
    />
    <rect x="884.4" y="351.6" width="28.44" height="28.44" fill="#2dea75" opacity="0.1" />
    <rect
      x="775.83"
      y="421.75"
      width="28.44"
    ...
    <path
      ...
      transform="translate(-47.24 -58.63)"
      fill="url(#ac3cc305-f6db-42f4-bbbd-32121ee27a74-563)"
    />
    <path
    ...
    <ellipse cx="132.73" cy="744.94" rx="97.44" ry="15.65" fill="#2dea75" opacity="0.1" />
    ...
    <path
      ...
      transform="translate(-47.24 -58.63)"
      fill="url(#ad14f186-b27f-416c-b629-0bafa2f1236e-564)"
    />
    <polygon
